...
class CouponTest extends TestCase
{
    ...
    public function it_gets_all_coupons()
    {
        ...
        $collection = $this->manager->coupons->all();

        $this->assertInstanceOf(Collection::class, $collection);
        $this->assertCount(2, $collection);
        $this->assertInstanceOf(Entities\Coupon::class, $collection->first());
    ...
    public function it_paginates_all_coupons()
    {
        ...
        $collection = $this->manager->coupons
            ->paginate(2, 1)
            ->all();
        ...
        $this->assertRequest(function (Request $request) {
            ...
            $this->assertEquals('coupons', $request->getUri()->getPath());
    ...
    public function it_gets_just_one_coupon_by_id()
    {
        ...
        $item = $this->manager->coupons(1)->get();

        $this->assertInstanceOf(Entities\Coupon::class, $item);
    ...
    public function it_sends_correct_parameters_when_creating_a_new_coupon()
    {
        ...
        $this->manager->coupons->create($attributes = [
            'name' => 'Acme Coupon',
        ]);
    ...
    public function it_can_be_updated()
    {
        ...
        $company = $this->manager->coupons(3)->update([
            'name' => 'Acme Coupon',
        ]);

        $this->assertInstanceOf(Entities\Coupon::class, $company);
        $this->assertInstanceOf(IdsEntity::class, $company);

        $this->assertRequest(function (Request $request) {
            $this->assertEquals('PUT', $request->getMethod());
            $this->assertEquals('coupons/3', $request->getUri()->getPath());
    ...
    public function it_can_be_deleted()
    {
        ...
        $result = $this->manager->coupons(2)->delete();
        $this->assertTrue($result);

        $this->assertRequest(function (Request $request) {
            $this->assertEquals('DELETE', $request->getMethod());
            $this->assertEquals('coupons/2', $request->getUri()->getPath());
        });
    }
}
