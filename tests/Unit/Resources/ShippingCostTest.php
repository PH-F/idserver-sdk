...
class ShippingCostTest extends TestCase
{
    ...
    public function it_gets_all_shippingCosts()
    {
        ...
        $collection = $this->manager->shippingCosts->all();

        $this->assertInstanceOf(Collection::class, $collection);
        $this->assertCount(2, $collection);
        $this->assertInstanceOf(Entities\ShippingCost::class, $collection->first());
    ...
    public function it_paginates_all_shippingCosts()
    {
        ...
        $collection = $this->manager->shippingCosts
            ->paginate(2, 1)
            ->all();
    ...
    public function it_gets_just_one_shippingCost_by_id()
    {
        ...
        $item = $this->manager->shippingCosts(1)->get();

        $this->assertInstanceOf(Entities\ShippingCost::class, $item);
    ...
    public function it_sends_correct_parameters_when_creating_a_new_shippingCost()
    {
        ...
        $this->manager->shippingCosts->create($attributes = [
            'name' => 'Acme ShippingCost',
        ]);
    ...
    public function it_can_be_updated()
    {
        ...
        $company = $this->manager->shippingCosts(3)->update([
            'name' => 'Acme ShippingCost',
        ]);

        $this->assertInstanceOf(Entities\ShippingCost::class, $company);
    ...
    public function it_can_be_deleted()
    {
        ...
        $result = $this->manager->shippingCosts(2)->delete();
