...
class EntityCreatorTest extends TestCase
{
    ...
    {
        $this->app['config']->set('idserver.classes', [
            Entities\Role::class => Stub\FakeRole::class,
        ]);
        ...
        $this->assertInstanceOf(Stub\FakeRole::class, $role);
        $this->assertEquals('admin', $role->name);
        $this->assertInstanceOf(Resources\Collection::class, $role->abilities);
        $this->assertInstanceOf(Stub\FakeAbility::class, $role->abilities->first());
    }
}
